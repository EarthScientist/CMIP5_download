				...
				for CMOR_table in CMOR_tables:
					for ensemble in ensembles:
						for variable in variables:
							...
							new_url=base_url+"model="+model+"&"+"experiment="+experiment+"&"+"time_frequency="+time_frequency+"&"+"cmor_table="+CMOR_table+"&"+"ensemble="+ensemble+"&"+"variable="+variable+"&"+"project=CMIP5"+"&"+"latest=true"
							...
							try:
								...
								local_file = open(os.path.join(outPath,model+'_'+variable+'_'+experiment+"_"+time_frequency+"_"+CMOR_table+'_'+ensemble+'.sh'), "wt")
								...
								wget_file=open(os.path.join(outPath,model+'_'+variable+'_'+experiment+"_"+time_frequency+"_"+CMOR_table+'_'+ensemble+'.sh'), "rt")
