...
# variable names
models=["IPSL-CM5A-LR"] # "MRI-CGCM3","GISS-E2-R","GFDL-CM3","IPSL-CM5A-LR","CCSM4" if all models want to be accessed simply comment this line out
...
downPath="/big_storage/malindgren/data/data_day_oct2012"
