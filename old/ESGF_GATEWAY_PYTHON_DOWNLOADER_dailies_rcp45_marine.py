...
# variable names
models=["MRI-CGCM3","GISS-E2-R","GFDL-CM3","IPSL-CM5A-LR","CCSM4"] # if all models want to be accessed simply comment this line out
experiments = ["rcp45"]#,"rcp26","rcp45","rcp60","rcp85"
...
outPath="/big_storage/malindgren/wget/wget_day_oct2012"
