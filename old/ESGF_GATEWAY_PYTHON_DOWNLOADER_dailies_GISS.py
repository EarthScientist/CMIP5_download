...
# variable names
models=["GISS-E2-R"] # "MRI-CGCM3","GISS-E2-R","GFDL-CM3","IPSL-CM5A-LR","CCSM4" if all models want to be accessed simply comment this line out
experiments = ["rcp45","rcp60","rcp85"]#,"rcp26","rcp45","rcp60","rcp85"
time_frequencies = ["day"]
realms = ["atmos"] 
CMOR_tables = ["day"] 
ensembles = ["r1i1p1"] # ,"r2i1p1" 
variables = ["uas","vas","tas","pr","psl"] # "tas","pr","psl",
...
outPath="/big_storage/malindgren/wget/wget_day_nov2012"
downPath="/big_storage/malindgren/data/data_day_nov2012"
