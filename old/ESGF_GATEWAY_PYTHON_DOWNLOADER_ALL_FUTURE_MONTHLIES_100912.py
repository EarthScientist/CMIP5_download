...
# variable names
#models=["CNRM-CM5","MPI-ESM-LR"] # if all models want to be accessed simply comment this line out
experiments = ["rcp45","rcp60", "rcp85"]#,"rcp26",
...
outPath="/big_storage/malindgren/wget/wget_futures/"
